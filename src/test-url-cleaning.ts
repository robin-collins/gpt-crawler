...
const INITIAL_HTML_OUTPUT_PATH = path.resolve('save_output', 'initial_page_content.html');
const CLEANED_HTML_OUTPUT_PATH = path.resolve('save_output', 'cleaned_page_content.html');
const SCREENSHOT_OUTPUT_PATH = path.resolve('save_output', 'full_page_screenshot.png');
// ---------------------
